...
MODULE = 'aeat_347'
PREFIX = 'trytonspain'
MODULE2PREFIX = {'account_es': 'trytonspain'}
OWNER = {
    'nantic':'NaN-tic',
    'trytonzz':'nanticzz',
}
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    download_url='https://github.com:trytonspain/trytond-aeat_347',
    ...
    project_urls = {
       "Source Code": 'https://github.com:trytonspain/trytond-aeat_347'
    },
    classifiers=[
